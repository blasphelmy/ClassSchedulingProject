...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_apiEvents] ([Id], [eventData], [eventUUID], [eventAuthorHash], [institutonID], [year], [quarter], [building], [room], [deliveryType], [coursePrefix], [courseNumber], [Section], [Component])
        SELECT   [Id],
                 [eventData],
                 [eventUUID],
                 [eventAuthorHash],
