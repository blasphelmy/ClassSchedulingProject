...
GO
PRINT N'Dropping Unique Constraint unnamed constraint on [dbo].[SessionTokens]...';


GO
ALTER TABLE [dbo].[SessionTokens] DROP CONSTRAINT [UQ__SessionT__2EEAD09C06EF237A];
