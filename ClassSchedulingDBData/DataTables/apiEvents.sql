...
(
	...
	[classQuarterNumber] int, --class quarter number
	[year] int not null,
	...
	constraint [apiEventCourseReferece] foreign key (courseID) references CourseOfferingsTemplates(Id),
)
